...
class ProductListingPage:
    ...
    def check_product_titles_for_brand_filters(self,brandname):
    ...
    def mensize_locator(self, mensize):
        MENSIZE_FLITER = (By.XPATH, "(//span[@class='a-list-item']/descendant::button[@value='"+mensize+"'])[1]")
        return MENSIZE_FLITER
